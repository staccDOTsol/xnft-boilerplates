...
export declare const ChatIDLJson: Idl & {
    metadata?: {
        address: string;
    };
};
export declare type ChatIDL = {
    "version": "3.9.2";
    "name": "chat";
    "instructions": [{
...
export declare type MessageType = Record<string, Record<string, any>>;
...
export declare type PostAction = Record<string, Record<string, any>>;
export declare const PostAction: {
    Hold: {
        hold: {};
    };
    Burn: {
...
export declare type PermissionType = Record<string, Record<string, any>>;
...
export declare type ChatType = Record<string, Record<string, any>>;
...
export declare type NamespacesV0 = IdlAccounts<ChatIDL>["namespacesV0"];
export declare type ChatV0 = IdlAccounts<ChatIDL>["chatV0"];
export declare type ChatPermissionsV0 = IdlAccounts<ChatIDL>["chatPermissionsV0"];
export declare type ProfileV0 = IdlAccounts<ChatIDL>["profileV0"];
export declare type SettingsV0 = IdlAccounts<ChatIDL>["settingsV0"];
export declare type DelegateWalletV0 = IdlAccounts<ChatIDL>["delegateWalletV0"];
export declare type CaseInsensitiveMarkerV0 = IdlAccounts<ChatIDL>["caseInsensitiveMarkerV0"];
