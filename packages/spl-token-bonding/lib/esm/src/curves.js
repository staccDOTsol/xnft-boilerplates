import { asDecimal } from "./utils";
export function fromCurve(curve, baseAmount, targetSupply, goLiveUnixTime) {
...
export class BaseExponentialCurve {
    c;
    baseAmount;
    targetSupply;
    goLiveUnixTime;
    ...
    sellTargetAmount(targetAmountNum, baseRoyaltiesPercent, targetRoyaltiesPercent, unixTime = now()) {
        return (-this.changeInTargetAmount(-targetAmountNum * (1 - asDecimal(targetRoyaltiesPercent)), 0, 0, unixTime) *
