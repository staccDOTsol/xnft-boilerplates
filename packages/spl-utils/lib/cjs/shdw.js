...
exports.randomizeFileName = exports.uploadFiles = exports.initStorageIfNeeded = exports.getStorageAccount = void 0;
...
function getOwnedAmount(provider, wallet, mint) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mintAcc = yield (0, _1.getMintInfo)(provider, mint);
        const acct = yield provider.connection.getAccountInfo(ata, "confirmed");
        if (acct) {
            return (0, _1.toNumber)(spl_token_1.u64.fromBuffer(spl_token_1.AccountLayout.decode(acct.data).amount), mintAcc);
        }
        return 0;
    });
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (provider) {
            ...
            if (shdwOwnedAmount < shdwNeeded) {
                ...
                tx.feePayer = pubKey;
                const signers = [...swapPayload.signers, delegateWallet].filter(_1.truthy);
                if (signers.length > 0) {
                    tx.partialSign(...signers);
                }
                if (!delegateWallet) {
                    tx = yield localProvider.wallet.signTransaction(tx);
                }
                yield (0, _1.sendAndConfirmWithRetry)(localProvider.connection, tx.serialize(), {
                    skipPreflight: true,
                }, "max");
