...
class SplTokenMetadata {
    ...
    uploadMetadata(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const [accountKey] = yield (0, shdw_1.getStorageAccount)(this.provider.wallet.publicKey, new anchor_1.BN(0));
            let randomId = Math.floor(Math.random() * (999 - 100 + 1) + 100);
            const metadata = Object.assign({ name: args.name, symbol: args.symbol, description: args.description, image: `https://shdw-drive.genesysgo.net/${accountKey.toBase58()}/${args.image.name}`, attributes: args.attributes, external_url: args.externalUrl || "", animation_rl: args.animationUrl, creators: args.creators ? args.creators : null, seller_fee_basis_points: 0 }, (args.extraMetadata || {}));
