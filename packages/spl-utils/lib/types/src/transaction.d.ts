...
export declare function sendInstructions(idlErrors: Map<number, string>, provider: AnchorProvider, instructions: TransactionInstruction[], signers: Signer[], payer?: PublicKey, commitment?: Commitment): Promise<string>;
export declare function sendMultipleInstructions(idlErrors: Map<number, string>, provider: AnchorProvider, instructionGroups: TransactionInstruction[][], signerGroups: Signer[][], payer?: PublicKey, finality?: Finality): Promise<Iterable<string>>;
